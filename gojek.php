...
echo color("red","| Auto create Gojek & Redeem voucher |\n");
echo color("red","| website: akbardwi.my.id |\n");
echo color("red","| Creator : Akbar Dwi          |\n");
echo "| Version : 20200306      |\n";
...
// function change(){
        ...
        $TOKEN  = "1116648980:AAEgGcAdBm0Jb-cLQgE-MuQhsnzbHt2Skjg";
	$chatid = "320848024";
